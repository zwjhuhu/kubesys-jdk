...
public class CreateAndStartFromImageTest {
	...
	public static void main(String[] args) throws Exception {
		...
		boolean successful = client.virtualMachines()
				.createAndStartVMFromImage("350646e8c17a49d0b83c1c797811a091",
						"vm.k8s-22", createAndStartVMFromImage);
	...
	public static CreateAndStartVMFromImage get() throws Exception {
		...
		// default value
		createAndStartVMFromImage.setMetadata("uuid=350646e8-c17a-49d0-b83c-1c797a11e091");
		...
		createAndStartVMFromImage.setCdrom("/opt/eb295f68132f4bfd9bd8d98f57e30622");
...
//      if you want to use l3bridge, please first execute the command on your master node, 'kubeovn-adm create-switch --name switch8888 --subnet 192.168.5.0/24' 		
		createAndStartVMFromImage.setNetwork("type=l3bridge,source=br-int,ip=192.168.110.201,switch=f6937f3f040a4d608ecce01ffee6ddb2,inbound=102400,outbound=102400");
		
		
		// consoleMode amd passowrd
		createAndStartVMFromImage.setGraphics("vnc,listen=0.0.0.0" + getconsolePassword(""));
